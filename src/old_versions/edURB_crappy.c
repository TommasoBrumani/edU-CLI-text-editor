...
{   
    ...
    docHead=malloc (sizeof(node_t));
    docHead->ind=0;
    docHead->parent=docHead;
    docHead->left=docHead;
    docHead->right=docHead;
    docHead->color = BLACK;
...
void eduC (node_t **docHead, pile_t**undoHead, pile_t**redoHead, char*in, node_t*docHead) 
{
    int ind1, ind2;
    pile_t*new;
    node_t*start;
